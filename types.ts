...
export const translations = {
  it: {
    ...
    welcomeText: "Siamo felicissimi! Non stiamo più nella pelle e vogliamo condividere con voi questa notizia! Stiamo organizzando questo matrimonio e vogliamo che sia un giorno speciale per tutti. In attesa del grande giorno, abbiamo creato questo sito dove puoi trovare tutte le informazioni.",
